...
/**
 * @brief Verifies if the parameters are valid to create a new user (id, name, email, phone_number, birth_date, sex , passport, country_code, address, account_creation, pay_method, account_status) 
 * 
