...
/**
 * @brief Verify if the paramenters is valid to create a new flight (parameters : id, airline, plane_model, total_seats, origin, schedule_departure_date, schedule_arrival_date, real_departure_date, real_arrival_date, pilot, copilot, notes)
 * 
 ...
 */
void setFlightScheduleDepartureDate(Flight flight, char *schedule_departure_date);
 ...
 * @param flight - The flight of type 'flight'
 * 
 * @return schedule_departure_date - The flight schedule departure date of type 'char*'
 */
 ...
 * @param flight - The flight of type 'flight'
 * 
 * @return schedule_arrival_date - The flight schedule arrival date of type 'char*'
 */
