...
void construct_reservation(char **parameters,
  ...
  update_general_stats_controller(general_data, begin_date_day, 0, 0, 0, 1,
                                  NULL);
  update_general_stats_controller(general_data, begin_date_month, 0, 0, 0, 1,
                                  NULL);
  update_general_stats_controller(general_data, begin_date_year, 0, 0, 0, 1,
                                  NULL);
}
